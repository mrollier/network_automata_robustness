...
class LLNA(tc.nn.Module):
    ...
    def forward(self, E:tc.Tensor, ht:tc.Tensor, T:int=1):
        ...
        ht  : float tensor of shape [L x N], where N and L are the number os nodes and initial configurations
        T   : number os steps to run the automaton
